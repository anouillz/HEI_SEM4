...
class RegexExercises:
    ...
    def east():
        ...
        """
        return r"\b(e|E)ast(\W|$)"  # bordure de mot pour ne pas inclure "eastern"
    ...
    def hyphenated():
        ...
        """
        return r"(\w+-\w+)(-\w+)*"  # un mot suivi d'un tiret et d'au moins un mot
    ...
    def digits():
        ...
        """
        return "^[0-9]+\s+"  # ^ pour le début de ligne, puis chiffres, puis espaces
    ...
    def ssn():
        ...
        """
        return r"\d+-\d+-\d+\s+"  # format type ssn suivi d'espaces
    ...
    def commaNumbers():
        ...
        """
        return r"\b*\d+,\d+\s+"  # un ou plusieurs groupes de chiffres séparés par des virgules
